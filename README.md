...
<div class="container">
    ...
    <div id="tab-0" class="exercise-section">
        <h2>📚 Native American Study List</h2>
        <div id="vocab-list"></div>
    </div>

    <div id="tab-1" class="exercise-section" style="display:none">
        <h2>✍️ Interactive Fill-in-the-Gaps</h2>
...
<script>
    const data = [
        { word: "husband", def: "A married man in relation to his partner.", sents: ["My ___ is cooking dinner tonight.", "They have been married for ten years."] },
        { word: "caretaker", def: "A person employed to look after a person or house.", sents: ["The elderly man has a full-time ___.", "Who is the ___ of this property?"] },
        { word: "emergency room", def: "A hospital department for urgent treatment.", sents: ["We had to go to the ___ after the accident.", "The ___ is very busy on Saturday nights."] },
        { word: "manage", def: "To succeed in doing something difficult.", sents: ["I finally ___ to finish the report on time.", "Did you ___ to find your keys?"] },
        { word: "each other", def: "Used to show a reciprocal action or relationship.", sents: ["They really love ___ very much.", "We should help ___ with the homework."] },
        { word: "countryside", def: "Land and scenery outside of towns and cities.", sents: ["We love taking long walks in the ___.", "The air is much fresher in the ___."] },
        { word: "belly", def: "The front part of the human body below the chest; stomach.", sents: ["I ate too much and now my ___ hurts.", "The baby was kicking inside her ___."] }
    ];
    ...
    function speakUS(text) {
        ...
        utter.voice = voices.find(v => v.lang === 'en-US' && v.name.includes('Google')) || voices.find(v => v.lang === 'en-US') || voices[0];
        utter.rate = 0.85;
        synth.speak(utter);
    }
